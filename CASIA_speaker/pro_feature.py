...
##模型pkl文件的文件夹路径
model_path = "feature_label_32000"
...
# 当前 .py 文件所在目录下的 CASIA_folds 文件夹
folder_path = Path(__file__).parent / 'CASIA_folds'
pkl_files = [f for f in folder_path.glob('*.pkl')]
...
for pkl_file in pkl_files:
    ...
    for train_sample in train_indices:
       ...
       #将特征和标签组成元组并存储到当前结果列表中
        ...
        print("feature", feature_train.shape)
        # print("label:",result)
